...
for tupl in listip:
    ...
    sender_ip=str(netifaces.ifaddresses(tupl[0])[2][0]['addr'])
    #print(sender_ip)
    #struct.pack('!I',int(hex(sender_ip),16))
    ...
    sock.bind((tupl[0],0))
    #print("socket bound")
    t = threading.Thread(target = rec, args=(sock,sender_ip,sender_mac,target_ip))
